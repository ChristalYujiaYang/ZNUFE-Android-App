...
public class Zixi_plan_style_xz extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.zixi_plan_xz);
		...
		gallery=(Gallery)findViewById(R.id.gallery_xz);
		gallery.setAdapter(new ImageAdapter(this));	
		gallery.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			public void onItemClick(AdapterView<?>parent,View v,int position,long id){
				switch(position){
				case 0:Toast.makeText(Zixi_plan_style_xz.this, "你选择了plan1", Toast.LENGTH_SHORT)
				.show();
				Intent plan1 = new Intent(Zixi_plan_style_xz.this, Plan_example.class);
				plan1.putExtra("num", xh);
				startActivity(plan1);
				break;
				case 1:Toast.makeText(Zixi_plan_style_xz.this, "你选择了plan2", Toast.LENGTH_SHORT)
				.show();
				Intent plan2 = new Intent(Zixi_plan_style_xz.this, Plan_example.class);
				plan2.putExtra("num", xh);
				startActivity(plan2);
				break;
				case 2:Toast.makeText(Zixi_plan_style_xz.this, "你选择了plan3", Toast.LENGTH_SHORT)
				.show();
				Intent plan3 = new Intent(Zixi_plan_style_xz.this, Plan_example.class);
		...
		class ImageAdapter extends BaseAdapter{
			private Integer[] mps={R.drawable.xuezha_1,R.drawable.xuezha_2,R.drawable.xuezha_3};
		...
		@SuppressLint("NewApi")
		private void init() {
			contentView = getLayoutInflater().inflate(R.layout.add_zixi_plan_xz, null,
					true);
					...
					public void onClick(View v) {
						...
						if (add_popupWindow.isShowing()) {
						     ...
						     style.setOnCheckedChangeListener(new OnCheckedChangeListener() {  
						    	 ...
						    	 if (checkedId == R.id.radio0||checkedId == R.id.radio1) {                    
						    		 if(checkedId == R.id.radio0){
						    			 Toast.makeText(Zixi_plan_style_xz.this, "学渣之王", Toast.LENGTH_SHORT)
										.show(); 					    	
						    	 } else {  
						    		 Toast.makeText(Zixi_plan_style_xz.this, "超级学渣", Toast.LENGTH_SHORT)
										.show();  
						    	 } Toast.makeText(Zixi_plan_style_xz.this, "普通学渣", Toast.LENGTH_SHORT)
									.show(); 
						    	 } }}); 
						     ...
						     queding.setOnClickListener(new OnClickListener() {
									...
									public void onClick(View v) {
									    add_popupWindow.dismiss();
									Toast.makeText(Zixi_plan_style_xz.this, "已保存", Toast.LENGTH_SHORT)
									.show();
									}
						...
						Toast.makeText(Zixi_plan_style_xz.this, e.getMessage(),
						Toast.LENGTH_SHORT);
						}
						}
						});
