...
public class ConcernMe extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.concern_me);
		
		gclist = (LinearLayout)findViewById(R.id.gclist2);
		jrlist = (LinearLayout)findViewById(R.id.jrlist2);
		btn1 = (Button)findViewById(R.id.concern_me_btn1); 
		
		Intent intent = getIntent();
		strXh = intent.getStringExtra("Xh");
		dbm=new DBManager(this);
		dbm.openDatabase();
		Cursor cur = dbm.getConcernMe(strXh);  
		cur.moveToFirst();  
		...
		{  
        	...
        	@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub 
        		Intent intent = new Intent(ConcernMe.this, HisPage.class);
